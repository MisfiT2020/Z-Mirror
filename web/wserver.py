...
@app.route("/")
def homepage():
    return "<h1>Visit my channel <a href='https://telegram.me/RaidenMirrors'>@RaidenMirrors</a>on Telegram By <a href='https://telegram.me/Temp_Acc_Misfit'>@Temp_Acc_Misfit</a></h1>"
